...
class VSCFullCapacity:
    ...
    def updating_values_to_excel_sheet(self):
        ...
        # Create dynamic lists based on the length of found_items
        ...
        try:
            ...
            for col_index, column_values in enumerate(created_lists.values(), start=1):
                print("first loop", col_index, column_values)
                if col_index == 1:
                    self.spec_val = 6.0
                elif col_index == 2:
                    self.spec_val = 10.0
                ...
                for row_index, value in enumerate(column_values, start=2):
                    print("second loop", row_index, value)
            ...
            print(f"Exception occcured while saving excel file with values is : {err}")
